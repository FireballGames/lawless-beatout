...
ARENA_WIDTH = config.config["window"]["size"][0] - (resource.HERO_SIZE[0] * 2)
ARENA_HEIGHT = 72  # 148

ARENA_Y = config.config["window"]["size"][1] - ARENA_HEIGHT - resource.HERO_SIZE[1]  # config.WIN_HEIGHT - ARENA_HEIGHT
